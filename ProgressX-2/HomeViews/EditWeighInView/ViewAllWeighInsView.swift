...
struct ViewAllWeighInsView: View {
    ...
    @StateObject private var viewModel = ViewAllWeighInsViewModel()
    ...
    var body: some View {
        ScrollView {
            VStack {
                BoldTitle(text: "Edit Weigh-in's")
                
                LightSubHeadline(text: "Here you can modify and delete your weigh-in's")
                    .padding(.bottom, 20)
...
#Preview {
    ...
    return ViewAllWeighInsView(navPath: $navPath)
