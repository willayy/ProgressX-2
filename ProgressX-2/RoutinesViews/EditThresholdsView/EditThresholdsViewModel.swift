...
class EditThresholdsViewModel: ObservableObject {
    ...
    public func setViewStartValues(selectedSetThreshold: SetThreshold) -> Void {
        ...
        editedTriggerQuantity = removeSubstrings(from: selectedSetThreshold.formattedTriggerQuantity, substrings: removeStrings)
        editedFlatLoadAdd = removeSubstrings(from: selectedSetThreshold.formattedFlatLoadAdd, substrings: removeStrings)
        editedFlatQuantityAdd = removeSubstrings(from: selectedSetThreshold.formattedFlatQuantityAdd, substrings: removeStrings)
