...
## SwiftLint
The project is configured to be able to run SwiftLint as it has a **.swiftlint** file and a script added to the
build phases that will run SwiftLint, HOWEVER, SwiftLint is currently disabled.
